...
STR: dict[str, str] = {
    ...
    "home.talk.sub": "Brainstorm with Copilot. It gets the code, the issues, and the talk so far.",
    ...
    "talk.lead": "Copilot gets the project code, the open issues, and this discussion. Ask a question, brainstorm, or discuss a group of issues.",
    "talk.empty": "No messages yet. Write the first one.",
    "talk.placeholder": "Write your message.",
    "talk.send": "Send to Copilot",
    "talk.you": "You",
    "talk.copilot": "Copilot",
    "talk.applied": "The reply is in the discussion.",
    "talk.discarded": "The discussion round is discarded.",
    "talk.restart": "Start a new discussion",
    "talk.restart.title": "Start a new discussion?",
    "talk.restart.body": "This removes the messages so far.",
    "talk.restart.yes": "Start new",
    "send.talk.title": "Copilot examines the project.",
