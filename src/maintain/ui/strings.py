...
STR: dict[str, str] = {
    ...
    "update.ready.sub": "Select to update. The app closes, installs the update, and starts again.",
    "update.skip": "Skip this version",
    "update.skipped": "Version {version} is skipped.",
    "update.confirm.title": "Update to version {version}?",
    "update.confirm.body": "The app closes, installs the update, and starts again. Your projects, runs, and issues stay.",
    ...
    "settings.updates": "Look for new versions",
    "home.talk": "Discuss the project",
    "home.talk.sub": "One package starts the talk in Copilot. Bring back issues or a request.",
    ...
    "done.apply": "Add the change to my files",
    "done.apply.sub": "The change is a commit on its own branch. Your project files do not have it yet.",
    "done.apply.done": "Your branch {branch} has the change. Your files are up to date.",
    "done.apply.here": "The change is in your files, on branch {branch}.",
    "done.apply.dirty": "Your project has changes that are not committed. Commit them or remove them, then try again.",
    "done.apply.branch": "Your project is on branch {current}. Move to branch {wanted}, then try again.",
    "done.apply.moved": "Branch {branch} moved after this run started. Use the merge command below.",
    ...
    "scan.ask.body": "Tell Copilot what to examine first.",
    "scan.update": "Update the package",
    "scan.coverage.all": "This scan holds all {total} project files.",
    "scan.coverage.part": "This scan holds {count} of {total} project files. {left} files stay for later scans.",
    "scan.coverage.last": "This scan holds the last {count} of {total} project files.",
    "scan.more": "{left} project files are not scanned. Select Scan again for the next part.",
    "scan.cycle.done": "All project files are scanned. The next scan starts over.",
    ...
    "talk.title": "Discuss the project",
    "talk.lead": "The package gives Copilot the project code and the open issues. You hold the discussion in Copilot.",
    "talk.topic": "Subject",
    "talk.topic.placeholder": "Name the subject, for example one group of issues. Empty is fine.",
    "talk.outcomes": "When you end the discussion, Copilot returns the outcome: new issues, a repair request, a feature request, or nothing.",
    "talk.start": "Create the package",
    "talk.none": "The discussion ended with no request.",
    "talk.request.applied": "The request from the discussion is in the description.",
    "talk.issues.unknown": "The reply names issue ids the tracker does not have.",
    "talk.discarded": "The discussion is discarded.",
    "send.talk.title": "Copilot discusses the project.",
