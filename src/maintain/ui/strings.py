...
STR: dict[str, str] = {
    ...
    "update.hidden": "The update notice is closed. It shows again at the next look.",
    "drop.title": "Delete this change?",
    "drop.body": "This deletes the change \"{name}\" and its work. You cannot get it back.",
    "drop.yes": "Delete it",
    ...
    "branch.tip": "The branch this project works on. Click to change it.",
    "branch.new": "New branch",
    "branch.new.body": "Give the new branch a name.",
    "branch.now": "The project is on branch {branch}.",
    "branch.busy": "The tool works now. Wait for the end, then change the branch.",
    "branch.dirty": "The project has changes that are not committed. Commit them or remove them, then try again.",
    "state.branch": "Branch {branch}",
    "state.clean": "no changes",
    "state.changed.one": "1 changed file",
    "state.changed": "{count} changed files",
    "state.synced": "same as the remote",
    "state.noremote": "no remote",
    "state.unsent": "not on the remote yet",
    "state.ahead.one": "1 commit to push",
    "state.ahead": "{count} commits to push",
    "state.behind.one": "1 commit to get",
    "state.behind": "{count} commits to get",
    "state.diverged": "{ahead} to push, {behind} to get",
    ...
    "exchange.step.back": "◀ Previous step",
    "exchange.step.forward": "Next step ▶",
    "exchange.step.none": "There is no earlier step to do again.",
    "exchange.step.back.done": "The run is at the earlier step.",
    "exchange.more": "More …",
    ...
    "done.push.done": "The commit is on the remote {name}.",
    "done.push.none": "This project has no remote, so the commit stays here.",
    "done.push.refused": "The remote refused the commit. Push it when you can.",
