...
TRANSITIONS = {
    ...
    RunState.TASKS_READY: {RunState.IMPLEMENTING, RunState.SCOPING, RunState.NEEDS_HUMAN,
                           RunState.FAILED, RunState.CANCELLED},
    RunState.IMPLEMENTING: {RunState.IMPLEMENTED, RunState.NEEDS_HUMAN, RunState.FAILED},
    RunState.IMPLEMENTED: {RunState.REVIEWING, RunState.NEEDS_HUMAN},
    RunState.REVIEWING: {RunState.TESTING, RunState.CHANGES_REQUESTED, RunState.NEEDS_HUMAN},
    RunState.CHANGES_REQUESTED: {RunState.REPAIRING, RunState.SCOPING, RunState.NEEDS_HUMAN},
    ...
    RunState.TEST_FAILED: {RunState.REPAIRING, RunState.SCOPING, RunState.NEEDS_HUMAN},
    RunState.VERIFIED: {RunState.AWAITING_ACCEPTANCE},
    RunState.AWAITING_ACCEPTANCE: {RunState.ACCEPTED, RunState.REPAIRING,
                                   RunState.NEEDS_HUMAN, RunState.CANCELLED},
